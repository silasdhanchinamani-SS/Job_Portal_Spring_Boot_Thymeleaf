...
public class MyEmailSender {
	...
	public void sendOtp(JobSeeker jobSeeker) {
		...
		try {
			...
			System.err.println("Failed to send OTP email to " + jobSeeker.getEmail() + ": " + e.getMessage());
			e.printStackTrace();
		}
	}
	...
	public void sendOtp(Recruiter recruiter) {
		...
		try {
			...
			System.err.println("Failed to send OTP email to " + recruiter.getEmail() + ": " + e.getMessage());
			e.printStackTrace();
		}
	}
